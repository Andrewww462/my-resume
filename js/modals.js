...
const modalFeedbackBtn = document.querySelector('#modal-feedback-btn');
...
const modals = [mobileMenu, myVideoModal, modalFeedback];
const buttons = [mobileMenuBtn, myVideoBtn, modalFeedbackBtn];
