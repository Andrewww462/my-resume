...
const modalFeedbackModal = document.querySelector('#modal-feedback');
...
callbackForm.addEventListener('submit', function(event){
    ...
    modalFeedbackModal.classList.add('modal-active');

    setTimeout(function() {
        modalFeedbackModal.classList.remove('modal-active');
    }, 2500);
});
